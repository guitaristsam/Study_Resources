...
Slightly modified but conceptually similar questions.
Emerging trends based on recent shifts in question patterns
Give more importance to latest papers(all are labeled by year)


Sort by weightage per topic and then find weightage of numericals and theory per topic and subtopic.(make me a table)
